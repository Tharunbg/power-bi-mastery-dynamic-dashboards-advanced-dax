...
```bash
git clone https://github.com/Tharunbg/Sales-Performance-Analysis.git
```  
...
## About the Developer
Tharun Kumar Bettadalli Girish is a Data Scientist with over 4 years of professional experience in data analytics and engineering. He specializes in transforming complex datasets into actionable business insights using tools like Power BI, SQL, Python, and Spark. This project serves as a demonstration of advanced business intelligence techniques and data storytelling.
